<%-- 
    Document   : ForgetPass
    Created on : May 30, 2024, 11:07:49 PM
    Author     : admin
--%>
...
<head>
    ...
    <meta property="og:title" content="Trang thành viên" />
						...
						<div class="page-login pagecustome clearfix">
							<div class="wpx">
								...
								<div id="login" class="section">
									<form accept-charset="utf-8" action="changepassword" id="customer_login" method="post">
                                        <input name="act" value="act_quen_mat_khau" type="hidden">
                                        <input name="back_url" value="" type="hidden" id="back_url">
									...
									<div class="form-signup clearfix">
										...
										<fieldset class="form-group">
                                                                                    <input type="text"  class="form-control form-control-lg" value="${requestScope.otp}" name="otp" placeholder="Email" required="">
										</fieldset>
                                                                                <fieldset class="form-group">
                                                                                    <input type="password"  class="form-control form-control-lg" value="${requestScope.password}" name="password" placeholder="Email" required="">
										</fieldset>
										<div class="pull-xs-left">
											<input class="btn btn-style btn_50" type="submit" value="Đổi mật khẩu">
										</div>
										<div class="btn_boz_khac">
											<div class="btn_khac">
											
												<a href="login" class="btn-link-style btn-register" title="Đăng nhập tại đây">Đăng nhập tại đây</a>
											</div>
										</div>
									</div>
