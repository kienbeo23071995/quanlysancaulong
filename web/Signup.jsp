<%-- 
    Document   : Signup
    Created on : May 30, 2024, 10:19:23 PM
    Author     : admin
--%>
...
<head>
    ...
    <title>Đăng ký</title>
    <meta name="description" content="Hệ thống shop cầu lông, tennis uy tín, chuyên nghiệp, phân phối dụng cụ cầu lông, vợt cầu lông, giày cầu lông, quần áo cầu lông tại TPHCM, Hà Nội, Đà Nẵng và giao hàng tận nơi toàn quốc.-Đăng ký" />
    ...
    <meta property="og:description" content="Hệ thống shop cầu lông, tennis uy tín, chuyên nghiệp, phân phối dụng cụ cầu lông, vợt cầu lông, giày cầu lông, quần áo cầu lông tại TPHCM, Hà Nội, Đà Nẵng và giao hàng tận nơi toàn quốc.-Đăng ký" />
            ...
            <div class="row">
               <div class="page-login pagecustome clearfix">
                  <div class="wpx">
                     ...
                     <span class="block a-center dkm margin-top-10">Đã có tài khoản, đăng nhập <a href="login" class="btn-link-style btn-register">tại đây</a></span>
                     <div id="login" class="section">
                        <form accept-charset="utf-8" action="register" id="customer_register" method="post">
                           <input name="act" value="act_dang_ky" type="hidden">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                 <fieldset class="form-group">
                                     <input type="text" class="form-control form-control-lg" value="${requestScope.fullName}" name="username" id="ten" placeholder="Nhập tên của bạn (*)" required="">
                                 </fieldset>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                 <fieldset class="form-group">
                                    <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" class="form-control form-control-lg" value="${requestScope.email}" name="email" id="email" placeholder="Nhập email của bạn (*)" required="">
                                 </fieldset>
                              </div>
                              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                 <fieldset class="form-group">	
                                     <input placeholder="Số điện thoại" type="text" pattern="\d+" class="form-control form-control-comment form-control-lg" value="${requestScope.phone}" name="phone" required="">
                                 </fieldset>
                              </div>
                              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                 <fieldset class="form-group">
                                     <input type="password" class="form-control form-control-lg" value="${requestScope.password}" name="password" id="password" placeholder="Mật khẩu" required="">
                                 </fieldset>
                              </div>
                              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                 <fieldset class="form-group">
                                     <input type="password" class="form-control form-control-lg" value="${requestScope.repassword}" name="re_password" id="re_password" placeholder="Nhập lại mật khẩu" required="">
                                 </fieldset>
                              </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                if(data !== ''){
                    if (data !== 'Đăng ký thành công!Kiểm tra email để xác thực tài khoản') {
