						...
						<div class="page-login pagecustome clearfix">
							<div class="wpx">
								...
								<div id="login" class="section">
									<form accept-charset="utf-8" action="forgetpass" id="customer_login" method="post">
									...
									<div class="form-signup clearfix">
										...
										<div class="btn_boz_khac">
											<div class="btn_khac">
												...
												<a href="/thanh-vien/dang-nhap" class="btn-link-style btn-register" title="Đăng nhập tại đây">Đăng nhập tại đây</a>
											</div>
										</div>
									</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                if(data !== ''){
                    if (data !== 'Kiểm tra email và làm theo hướng dẫn để lấy lại mật khẩu') {
                    ...
                    toastr.options = {
                        ...
                        "onHidden": function () {
                            ...
                            window.location.href = '${pageContext.request.contextPath}/changepassword?email=${requestScope.email}'; // Thay đổi URL thành trang bạn muốn chuyển đến
                        }
                    };
